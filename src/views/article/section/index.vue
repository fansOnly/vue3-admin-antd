...
import { getSectionIndex as getDataList, deleteSection as deleteDataList } from '@/api/article'
...
export default {
    ...
    methods: {
        ...
        routePage (option, editId) {
            if (option == 'add') {
                this.$router.push({name: 'sectionAdd', params: {pid: editId}});
            } else if (option == 'edit') {
                this.$router.push({name: 'sectionEdit', params: {id: editId}});
            } else {
